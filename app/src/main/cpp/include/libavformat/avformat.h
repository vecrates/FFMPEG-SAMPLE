...
enum AVStreamParseType {
    ...
    AVSTREAM_PARSE_TIMESTAMPS, /**< full parsing and interpolation of timestamps for frames not mRunning on a packet boundary */
 ...
 *
 * @param opaque a pointer where libavformat will store the iteration mState. Must
