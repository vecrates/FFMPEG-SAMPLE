...
typedef struct AVFilter {
     ...
     * called or failed, so it must be init to handle such a situation.
     */
...
struct AVFilterContext {
    ...
    int is_disabled;                ///< the enabled mState from the last expression evaluation
 ...
 *
 * @param opaque a pointer where libavfilter will store the iteration mState. Must
