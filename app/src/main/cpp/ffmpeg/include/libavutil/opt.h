 ...
 * Iterate over potential AVOptions-enabled children of parent.
 *
 * @param iter a pointer where iteration mState is stored.
 * @return AVClass corresponding to next potential child or NULL
 */
 ...
 *
 * Options o must belong to the obj. This function must not be called to check child's options mState.
